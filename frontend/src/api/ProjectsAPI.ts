...
const API_URL =
  'https://waterproject-taylor-backend.azurewebsites.net/api/Water';
...
export const fetchProjects = async (
  ...
  try {
    ...
    const url = `${API_URL}/AllProjects?pageLength=${pageSize}&pageNum=${pageNum}${selectedCategories.length ? `&${categoryParams}` : ''}`;
